...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // WEATHER REPORTER
        System.out.println("--- WEATHER REPORTER ---\n");
        System.out.println("Let us create a weather reporter");
        WeatherReporter myWeatherReporter = new WeatherReporter("Cape Town", 29);
